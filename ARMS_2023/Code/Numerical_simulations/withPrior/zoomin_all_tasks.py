...
class stmria:
    ...
    def calc_selection_index(self, trait_aggsarg, radius, ite, min_task):
        '''
        ...
        mu = mu/high_mu
        #if maxmin:
            #min_task = self.find_min_task(high_mu.reshape(1,3))
    ...
    def select_arms_and_zoomin(self):
        ...
        for ite in range(self.T):
            ...
            if (allocation != 0).any():
                ...
                self.zooming_dict['conf_radius'][arm] = 1 * self.confidence_radius(ite, self.zooming_dict['num_pulled'][arm])
